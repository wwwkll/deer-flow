...
export const enUS: Translations = {
  ...
  globalVariables: {
    ...
    searchThreadPlaceholder: "Enter thread ID...",
    selectThreadPlaceholder: "Select a thread...",
    searchThreadKeywordPlaceholder: "Search by thread title...",
    noThreadsFound: "No matching threads found",
